    ...
    <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <motion.div variants={item} className="md:col-span-2" id="ai-coach">
          <Card className="h-full bg-white/5 border-white/10 hover:border-blue-500/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] transition-all duration-300 group">
        ...
        <motion.div variants={item}>
          <Card className="h-full bg-white/5 border-white/10 hover:border-white/20 hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] transition-all duration-300 group">
