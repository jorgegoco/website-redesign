...
export function SpotCard({ spot }: { spot: SpotData }) {
  ...
  return (
    ...
    >
      <Card
        className={`bg-white/5 border-white/10 hover:border-white/20 hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] transition-all duration-300 overflow-hidden ${
              ...
              >
                ...
                <div className="flex gap-3 mt-4">
                  <Button
                    variant="outline"
                    size="sm"
                    className="rounded-full border-white/10 text-gray-400 hover:text-white text-xs"
                    asChild
                  >
