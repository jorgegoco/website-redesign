      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-full border border-white/10 bg-transparent px-4 py-2 text-sm font-medium text-white hover:bg-white/5 transition-colors w-fit"
          >
        ...
        <ScrollArea className="w-full">
          <div className="flex gap-4 pb-4">
            {videos.map((video, i) => (
              ...
              >
                <Card className="bg-white/[0.08] border-white/[0.15] hover:border-white/20 transition-all duration-300 overflow-hidden group cursor-pointer">
